...
de_friend_service_register_s2c(Size1, Rest1) ->
    <<User_idLen:16, DeUser_id:User_idLen/bytes, Rest2:(Size1 - 16 - User_idLen)/binary>> = Rest1, 
    Size2 = Size1 - 16 - User_idLen, 
    <<Agent_typeLen:16, DeAgent_type:Agent_typeLen/bytes, Rest3:(Size2 - 16 - Agent_typeLen)/binary>> = Rest2, 
    Size3 = Size2 - 16 - Agent_typeLen, 
    <<Agent_addrLen:16, DeAgent_addr:Agent_addrLen/bytes, Rest4:(Size3 - 16 - Agent_addrLen)/binary>> = Rest3, 
    Size4 = Size3 - 16 - Agent_addrLen, 
...
de_friend_service_join_s2c(Size1, Rest1) ->
    <<TypeLen:16, DeType:TypeLen/bytes, Rest2:(Size1 - 16 - TypeLen)/binary>> = Rest1, 
    Size2 = Size1 - 16 - TypeLen, 
    <<Channel_idLen:16, DeChannel_id:Channel_idLen/bytes, Rest3:(Size2 - 16 - Channel_idLen)/binary>> = Rest2, 
    Size3 = Size2 - 16 - Channel_idLen, 
    <<User_idLen:16, DeUser_id:User_idLen/bytes, Rest4:(Size3 - 16 - User_idLen)/binary>> = Rest3, 
    Size4 = Size3 - 16 - User_idLen, 
...
de_friend_service_send_s2c(Size1, Rest1) ->
    <<TypeLen:16, DeType:TypeLen/bytes, Rest2:(Size1 - 16 - TypeLen)/binary>> = Rest1, 
    Size2 = Size1 - 16 - TypeLen, 
    <<To_idLen:16, DeTo_id:To_idLen/bytes, Rest3:(Size2 - 16 - To_idLen)/binary>> = Rest2, 
    Size3 = Size2 - 16 - To_idLen, 
    <<From_idLen:16, DeFrom_id:From_idLen/bytes, Rest4:(Size3 - 16 - From_idLen)/binary>> = Rest3, 
    Size4 = Size3 - 16 - From_idLen, 
    <<DataLen:16, DeData:DataLen/bytes, Rest5:(Size4 - 16 - DataLen)/binary>> = Rest4, 
    Size5 = Size4 - 16 - DataLen, 
